...
public class EvalMovesSuccessful extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_previous:
                    Intent intent_previous = new Intent(EvalMovesSuccessful.this,EvalMovesWereAttempted.class);
                    intent_previous.putExtra("key", strategyName);
                    startActivity(intent_previous);
                    finish();
                    return true;

                case R.id.navigation_next:
                    Intent intent_eval_moves_attempted = new Intent(EvalMovesSuccessful.this,EvalMovesHardest.class);
                    Bundle b = new Bundle();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eval_moves_successful);
