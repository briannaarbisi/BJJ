...
public class EvalMovesHardest extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_previous:
                    Intent intent_eval_moves_attempted = new Intent(EvalMovesHardest.this,EvalMovesSuccessful.class);
                    Bundle b = new Bundle();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eval_moves_hardest);
